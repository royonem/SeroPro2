...
public class ProDetailsVO {
	...
	public String toString() {
		return "ProDetailsVO [proNum=" + proNum + ", proPos=" + proPos + ", proName=" + proName + ", proAddress="
				+ proAddress + ", proSchool=" + proSchool + ", proDetails=" + proDetails + ", proVid=" + proVid
				+ ", proAge=" + proAge + ", proHeight=" + proHeight + ", batAvg=" + batAvg + ", war=" + war + ", ops="
				+ ops + ", era=" + era + ", whip=" + whip + ", mbti=" + mbti + ", proSign=" + proSign + "]";
	}
